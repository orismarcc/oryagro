                ...
                return (
                  <motion.div key={p.id} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.97 }} transition={{ delay: i * 0.04, duration: 0.25 }}>
                    <button onClick={() => onSelectPropriedade(p)} className="card-interactive w-full text-left p-4 flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: isMember ? 'hsl(217 91% 60% / 0.1)' : 'hsl(156 64% 31% / 0.1)' }}>
                        <Building2 size={18} style={{ color: isMember ? 'hsl(217 91% 60%)' : 'hsl(156 64% 31%)' }} />
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1 mt-1">
                          <Layers size={10} style={{ color: isMember ? 'hsl(217 91% 60%)' : 'hsl(156 64% 31%)' }} />
